...
async def generate_one_problem_async(difficulty: str) -> Optional[Dict]:
    """Generate a problem using Gemini's JSON mode with retries (async)."""
...
async def background_generator_async():
...
async def generate_pool():
    ...
    asyncio.create_task(fill_pool_async())
...
async def start_generator():
    ...
    if not generator_running:
        ...
        asyncio.create_task(background_generator_async())
